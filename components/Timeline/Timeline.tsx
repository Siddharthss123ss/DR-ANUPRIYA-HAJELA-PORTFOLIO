...
const timelineData = [
  {
    ...
    desc: "Completed MBBS with strong academic excellence and advanced medical foundation from Gandhi Medical College, Bhopal with distinction in multiple subjects.",
    icon: GraduationCap,
  ...
  },
  {
    ...
    desc: "Completed MS in ENT with Gold Medal with award for being the best successful candidate in MS examination and advanced surgical training.",
    icon: Award,
  ...
  },
  {
    ...
    desc: "Fellowship in Endoscopic Sinus & Skull Base Surgery from Bombay Hospital, Mumbai under the guidance of Dr.Nishit Shah.",
    icon: Microscope,
  ...
  },
  {
    ...
    desc: "Specialized Fellowship in Allergy and Clinical Immunology from Saveetha Medical College, Chennai.",
    icon: Stethoscope,
  ...
  },
  {
    ...
    desc: "Advanced fellowship training in Laryngology and voice disorder treatments from Bombay Hospital,Mumbai under Dr. Nupur Kapoor Nerurkar.",
    icon: Microscope,
